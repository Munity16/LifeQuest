...
- **Current branch:** `codex/ui-ux-9-plus`, stacked on the verified lockfile repair branch so this usability pass remains isolated from the open CI repair pull request.
